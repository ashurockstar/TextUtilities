...
export default function Navbar(props) {
    return (
        <nav className={`navbar navbar-expand-lg navbar-${props.mode !== "props.mode" ? "dark" : "light"} bg-${props.mode !== "props.mode" ? "dark" : "light"}`}>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div className={`form-check form-switch text-${props.mode === "props.mode" ? "dark" : "light"}`}>
                    <button type="button" className="btn btn-light round-button mx-1" value="white" onClick={e => props.toggleDarkMode(e)}></button>
